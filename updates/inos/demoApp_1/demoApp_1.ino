// This app starts in full mode
// It falls back to Limited mode after a sequence of failures
// It switches to full mode after it connects again as an accepted device

// Unwelcome copies will work only temporary when you use this setup
...
static const char app_name[] PROGMEM = "demoApp_1";
...
// boolean to know in which mode we run and we start in full mode
bool fullMode = true;
...
int numberFails = 0;    // Count consequtive failures ( reset to 0 after success )
